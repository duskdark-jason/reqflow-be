...
| `/requirement/mcp/key/config` | GET | `req:mcp:key:list`、`req:mcp:key:add` 或 `req:mcp:key:edit` | 查询 MCP 地址、请求头名、Codex 配置模板、全局 skill 包和 Codex 安装指令包 |
